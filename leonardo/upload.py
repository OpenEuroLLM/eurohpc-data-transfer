...
source_dir = "/leonardo_work/AIFAC_L01_028/datasets/hplt4-parquet-sharded"  # absolute path on Leonardo
remote_host = "transfer3.bsc.es"  # remote SFTP host
remote_user = "ella189763"  # your username on the remote host
remote_dest = "/gpfs/scratch/ehpc532/datasets/hplt4-parquet-sharded"  # destination path on remote host
